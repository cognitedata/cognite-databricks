...
> **Base URL & TOML:** Look up your **Cognite API URL** — [§1](./deployment.md#1-i-need-my-base-url). **PSaaS / Private Link:** set `base_url` in TOML per [§2](./deployment.md#2-i-need-toml) (e.g. `p001.plink.<cluster>.cognitedata.com`) and read [§4](./deployment.md#4-what-psaas-base-url-means).
